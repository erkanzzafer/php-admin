...
if ($_POST) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($_POST['save']) && (@$_POST['save'] == "1001")) {
            ...
            $user_id = 1;
            $sql = "INSERT INTO qp_vizyon(title,description,created_at,user_id,status) VALUES(?,?,?,?,?)";
            ...
            $sql = "DELETE FROM qp_vizyon WHERE id= ? ";
            $args = [$deleteId];
            ...
            $description = $_POST['description'];
            $status = $_POST['status'];
            $sql = "UPDATE qp_vizyon SET title=? , description=?,status=? WHERE id=? ";
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM qp_vizyon ORDER BY id DESC";
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">VİZYONUMUZ | Sil <?php print $value['id']; ?></h4>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">VİZYONUMUZ | Yeni Ekle</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
